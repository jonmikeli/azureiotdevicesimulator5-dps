...
docker build -t iothubsdk-api -f ..\sources\IoT.Simulator\IoT.Simulator.API.DeviceManagement\IoT.Simulator.API.DeviceManagement.API\Dockerfile ..\sources\IoT.Simulator\IoT.Simulator.API.DeviceManagement
