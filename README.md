...
## New features
This version of the Azure IoT Device Simulator integrates the use of a DPS (Device Provisioning Service).
It implements provisioning based on:
 - group enrollment with:
   - symmetric keys
